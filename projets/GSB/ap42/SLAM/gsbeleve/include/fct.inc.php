 ...
 * @package default
 * @author Cheri Bibi
 * @version    1.1 version MVC modifiee le 4 janvier 2023 par Blain Pascal
 */
 /**
...
function connecter($id,$nom,$prenom,$statut){
	...
	if ($statut=='1') {$_SESSION['typeUtilisateur'] = 'Visiteur';$_SESSION['statut']= 'V';}
	if ($statut=='0') {$_SESSION['typeUtilisateur'] = 'Administrateur';$_SESSION['statut']= 'A';}
	if ($statut=='3') {$_SESSION['typeUtilisateur'] = 'Comptable';$_SESSION['statut']= 'C';}
