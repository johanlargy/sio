...
<?php
 	if ($_REQUEST['action']=="supprimer") 
		...
		echo '
	<form name="unFraisHorsForfait" action="index.php?uc=gererFraisHorsForfait&action=validerSupprimer&idFrais='.$unFrais['lhId'].'&LibelleHorsForfait='.$unFrais['lhLibelle'].'" method="POST">';} 
	else 
